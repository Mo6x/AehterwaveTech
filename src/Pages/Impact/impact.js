        ...
        <div className='impact-lists'>
             ...
             <div className='impact-cards'>
                <div className='impact-card'>
                   ...
                   AehterWave Technologies can aid technicians in identifying equipment issues and performing repairs efficiently. Using AR-powered smart glasses or mobile devices, technicians can access real-time visual instructions, diagrams, and troubleshooting guides, reducing downtime and minimizing errors.
                   </p>
                </div>
                ...
                <div className='impact-card'>
                   ...
                   <p className='impact-p'>
                   In manufacturing processes, AehterWave Technologies can enhance quality control by automating visual inspections. AI-powered image recognition can identify defects, deviations, and anomalies in products, ensuring consistency and precision in production.
                   </p>
                </div>
                ...
                <div className='impact-card'>
                   ...
                   <p className='impact-p'> 
                   AehterWave Technologies can optimize supply chain operations. AI-powered cameras can monitor inventory levels, track shipments, and ensure efficient warehouse management, reducing waste and improving inventory accuracy.
                   </p>
                </div>
                ...
                <div className='impact-card'>
                   ...
                   <p className='impact-p'>
                   AehterWave Technologies can improve documentation processes by capturing and storing visual data from inspections, maintenance, and other operations. This data can then be used for knowledge sharing, historical analysis, and process optimization.
                   </p>
                </div>
                ...
                <div className='impact-card'>
                   ...
                   <p className='impact-p'> 
                   AehterWave Technologies can enhance safety protocols and compliance. AR overlays can provide real-time safety instructions and highlight potential hazards, helping workers follow safety guidelines more effectively.
                   </p>
                </div>
             </div>
        </div>
